...
ARG PYPI_USERNAME
ARG PYPI_PASSWORD
RUN set -e && if [ "$PYPI_USERNAME" != "" ]; then twine upload /home/cloudsdk/app/target/dist/stanford-wdl-kit-1.6.1/dist/* -u $PYPI_USERNAME -p $PYPI_PASSWORD ; fi;
...
USER cloudsdk
COPY --chown=cloudsdk:cloudsdk --from=build /home/cloudsdk/app/target/dist/stanford-wdl-kit-1.6.1/dist/stanford-wdl-kit-1.6.1.tar.gz /home/cloudsdk/app
